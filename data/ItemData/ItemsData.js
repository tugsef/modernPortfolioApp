...
export const languages = [
  { name: "Python", icon: <TbBrandPython className="text-white" />, skor: 100 },
  { name: "Java", icon: <BiLogoJava className="text-white" />, skor: 350 },
  {
    name: "Springboot",
  ...
  { name: "React", icon: <BiLogoReact className="text-white" />, skor: 325 },
  {
    name: "Tailwind",
...
export const tools = [
  { name: "Framer", icon: <RxFramerLogo className="text-white" />, skor: 250 },
];
