  ...
  return (
    <div className="cursor-pointer ">
      ...
      {showDetail === project.id && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-slate-600 bg-blue-100  rounded-lg md:p-10 md:grid-cols-2 gap-x-12 dark:bg-gray-400 dark:text-white ">
          <motion.div
            variants={stagger}
            initial="initial"
            animate="animate"
