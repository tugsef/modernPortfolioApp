  ...
  return (
    <div className="cursor-pointer">
      ...
      {showDetail === certificate.id && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-slate-600 bg-blue-200 rounded-lg bg-opacity-0.5 lg:px-48 lg:py-20  dark:bg-gray-400">
